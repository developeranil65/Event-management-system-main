                          ...
                          <div className="flex-1 flex flex-col justify-between">
                            ...
                            <div className="flex justify-between pt-4 md:pt-0 gap-2">
                              {reg.status === "cancelled" ? null : (
                                <>
                                  <Button variant="outline" className="text-xs h-8 border-rose-500/30 text-rose-500 hover:bg-rose-500/10" onClick={() => setSelectedTicket(reg)}>
                                    View Details
                                  </Button>
                                  <Button variant="outline" className="text-xs h-8 bg-rose-600 border-rose-500/30 text-white hover:bg-red-400" onClick={() => { setSelectedRegistrationId(reg._id); setIsModalOpen(true); }}>
                                    Cancel Registration
                                  </Button>
                                </>
                              )}
...
<<<<<<< HEAD
      ...
      <ConfirmationModal
        isOpen={isModalOpen}
        onClose={() => { setIsModalOpen(false); setSelectedRegistrationId(null); }}
